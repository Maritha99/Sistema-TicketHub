    ...
    public function numeros_paginas() {
        ...
        for($i = 1; $i <= $this->total_paginas(); $i++) {
            if($i === $this->pagina_actual ) {
                $html .= "<span class=\"paginacion__enlace paginacion__enlace--actual \">{$i}</span>"; // la pagina en la cual estamos
            } else {
                $html .= "<a class=\"paginacion__enlace paginacion__enlace--numero \" href=\"?page={$i}\">{$i}</a>";  // la pagina que nos llevara
            }
        }
