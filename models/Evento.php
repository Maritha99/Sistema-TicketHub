...
class Evento extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'nombre', 'descripcion', 'disponibles', 'categoria_id','fechahora','hora','ponente_id'];
    ...
    public function __construct($args = [])
    {
        ...
        $this->fechahora = $args['fechahora'] ?? '';  //nuevo campo
        $this->fechahora = $args['hora'] ?? '';  //nuevo campo
    ...
    public function validar() {
        ...
        if(!$this->ponente_id || !filter_var($this->ponente_id, FILTER_VALIDATE_INT) ) {
            self::$alertas['error'][] = 'Selecciona la organización encargada del evento';
        }
