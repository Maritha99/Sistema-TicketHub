...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            ...
            <p class="resumen__texto">Organizadores</p>
        </div>
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            <p class="resumen__texto resumen__texto--numero"><?php echo $eventos_total; ?></p>
            <p class="resumen__texto">Eventos</p>
        </div>

        <div <?php aos_animacion(); ?> class="resumen__bloque">
            <p class="resumen__texto resumen__texto--numero">500</p>
            <p class="resumen__texto">Ventas</p>
        </div>
    </div>
</section>

<section class="speakers">
    <h2 class="speakers__heading">Organizadores</h2>
    <p class="speakers__descripcion">Conoce a nuestros Organizadores</p>
...
<!--aqui abajo ira los ponentes y mapas xd---->